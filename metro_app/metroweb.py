...
def metroweb_network(Simple,
    ...
    file_path_1 = filedialog.askopenfilename(
        initialdir="/Users/ndiayeabass/desktop/Metropolis/CY/Tasks",
    ...
    if Simple:
        ...
        nodes_gdf = gpd.GeoDataFrame(
            nodes_df, crs=initial_crs, geometry=nodes_geometry)
        edges_gdf = gpd.GeoDataFrame(
            edges_df, crs=initial_crs, geometry=edges_geometry)
