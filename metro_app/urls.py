...
from .views import (create_project, delete_nodes, delete_roads_types,
                    delete_zones, create_roadtype,
                    project_details, update_project,
                    delete_project, index,
                    visualization, edges_point_geojson,
...
from metro_app.road_network.views import (
                                          ...
                                          list_of_road_networks, list_of_zonesets,
                                          list_of_od_matrix, list_of_preferences,
                                          list_of_populations, list_of_runs,
                                          )
...
urlpatterns = [
     ...
     path('network/<str:pk>/details/', road_network_details, name='road_network_details'),
